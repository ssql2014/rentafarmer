...
RentAFarmer 是一个 Codex skill 和轻量演示项目。用户用中文说明想种的一种或多种蔬菜，AI 根据当前季节、地块面积、光照、土壤、水源和预算生成种植意向建议。用户确认意向后，加微信进入主理人核地块、核农时和最终报价。
...
AI 输出推荐品种、面积、费用预估、周期、服务配置和微信承接话术。默认服务特色是有机方式管护、不打农药、24 小时视频监控、当地农民提供服务。瓜果成熟后，用户可以自行采摘、邮寄到家，或委托主理人代为销售。
